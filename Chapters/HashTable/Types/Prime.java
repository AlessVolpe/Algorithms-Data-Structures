...
public class Prime {
    ...
    static int nextPrime(int n) {
        ...
        boolean fermatPT = fermatPrimalityTest(prime),
                simplePT = simplePrimalityTest(prime),
                naivePT = naivePrimalityTest(prime);

        System.out.println("Running different Primality Tests");

        System.out.println("Naive: " + naivePT);
        System.out.println("Simple: " + simplePT);
        System.out.println("Fermat's: " + fermatPT);
